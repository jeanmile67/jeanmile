...
import { Linkedin, Facebook, GitHub, Twitter } from 'react-feather';
import HeroWrapper, { ParallaxWrapper, ScrollDown } from './Hero.style';
...
const Hero = (props) => {
  ...
  const bind = useMove(({ movement: [mx, my] }) => {
    api.start({ x: (mx * -1) / 8, y: (my * -1) / 10 });
  });

  return (
    <HeroWrapper
      id="home"
      className={props.light ? 'home d-flex align-items-center light' : 'home d-flex align-items-center'}
      {...bind()}
    >
      <div className="container">
        ...
        <ParallaxWrapper data-relative-input="true">
          <animated.svg width="27" height="29" className="layer p1" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <path
          ...
          <animated.svg width="26" height="26" className="layer p2" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <path
          ...
          <animated.svg width="30" height="25" className="layer p3" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <path
          ...
          <animated.svg width="15" height="23" className="layer p4" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <rect
          ...
          <animated.svg width="15" height="23" className="layer p5" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <rect
              transform="rotate(30 9.86603 10.13397)"
              x="7"
              width="3"
          ...
          <animated.svg width="49" height="17" className="layer p6" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
          ...
          <animated.svg width="26" height="26" className="layer p7" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <path
          ...
          <animated.svg width="19" height="21" className="layer p8" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <rect
          ...
          <animated.svg width="30" height="25" className="layer p9" xmlns="http://www.w3.org/2000/svg" style={{ x, y }}>
            <path
